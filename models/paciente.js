...
var pacienteSchema = new Schema({
	nombre: { type: String, lowercase: true, trim: true, required: true },
	apellido: { type: String, lowercase: true, trim: true, required: true },
	cedula: { type: String, lowercase: true, trim: true, unique: true, required: true},
